...
registerTool({
    ...
    parameters: {
        ...
        action_type: { type: 'string', description: 'Action type', enum: ['send_notification', 'open_app', 'create_task', 'run_command', 'navigate_url', 'send_to_board', 'authorize_app'], required: true },
